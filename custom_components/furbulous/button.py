...
async def async_setup_entry(
    ...
    buttons = []
    # Manual cleaning control buttons
...
class FurbulousCatPauseCleanButton(CoordinatorEntity, ButtonEntity):
    ...
    def __init__(
        ...
        self._attr_name = f"{device['name']} Pause Cleaning"
...
class FurbulousCatResumeCleanButton(CoordinatorEntity, ButtonEntity):
    ...
    def __init__(
        ...
        self._attr_name = f"{device['name']} Resume Cleaning"
...
class FurbulousCatPackButton(CoordinatorEntity, ButtonEntity):
    ...
    def __init__(
        ...
        self._attr_name = f"{device['name']} Pack"
